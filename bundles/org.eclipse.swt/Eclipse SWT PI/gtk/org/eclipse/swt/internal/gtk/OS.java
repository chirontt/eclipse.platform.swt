...
public class OS extends C {
	 ...
	 * @category custom
	 */
	public static final native long content_providers_create_gtype(String name);

	/**
	 * Creates a GValue for the given GType, when that GType was created by
	 * {@link #content_providers_create_gtype(String)}
	 *
	 * @param gtype the type created with {@link #content_providers_create_gtype(String)}
	 ...
	 * @category custom
	 */
	public static final native long content_providers_create_gvalue(long gtype, long value);
